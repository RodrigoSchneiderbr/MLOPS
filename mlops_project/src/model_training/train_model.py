...
def load_data() -> pd.DataFrame:
    ...
    """
    train_path = "C:\\Users\\schne\\OneDrive\\Desktop\\udemy\\MLOPS\\projeto_MLOPS\\mlops_project\\data\\processed\\train_processed.csv"
...
def load_params() -> dict:
    ...
    # Mude de ["train_model"] para ["train"] para bater com o seu YAML
    return params["train"]
...
def prepare_data(train_data: pd.DataFrame) -> tuple[pd.DataFrame, np.ndarray, OneHotEncoder]:
    ...
    # One-hot encode para modificar string
...
def create_model(
    ...
    model = Sequential(
        [
            ...
            Dropout(params["dropout_rate"]), # evita overfitting
...
def save_training_artifacts(model: tf.keras.Model, encoder: OneHotEncoder) -> None:
    ...
    models_dir = "C:\\Users\\schne\\OneDrive\\Desktop\\udemy\\MLOPS\\projeto_MLOPS\\mlops_project\\models"
