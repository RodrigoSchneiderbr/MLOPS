...
def load_preprocessed_data() -> tuple[pd.DataFrame, pd.DataFrame]:
    ...
    """
    train_path = "C:\\Users\\schne\\OneDrive\\Desktop\\udemy\\MLOPS\\projeto_MLOPS\\mlops_project\\data\\preprocessed\\train_preprocessed.csv"
    test_path = "C:\\Users\\schne\\OneDrive\\Desktop\\udemy\\MLOPS\\projeto_MLOPS\\mlops_project\\data\\preprocessed\\test_preprocessed.csv"
...
def save_artifacts(
    ...
    """
    # Save processed data
    output_dir = "C:\\Users\\schne\\OneDrive\\Desktop\\udemy\\MLOPS\\projeto_MLOPS\\mlops_project\\data\\processed"
    ...
    # Save scaler
    scaler_path = os.path.join("C:\\Users\\schne\\OneDrive\\Desktop\\udemy\\MLOPS\\projeto_MLOPS\\mlops_project\\artifacts", "[features]_scaler.joblib")
