...
def load_model() -> tf.keras.Model:
    ...
    """
    model_path = "C:\\Users\\schne\\OneDrive\\Desktop\\udemy\\MLOPS\\projeto_MLOPS\\mlops_project\\models\\model.keras"
...
def load_encoder() -> LabelEncoder:
    ...
    """
    encoder_path = "C:\\Users\\schne\\OneDrive\\Desktop\\udemy\\MLOPS\\projeto_MLOPS\\mlops_project\\artifacts\\[target]_one_hot_encoder.joblib"
...
def load_test_data() -> tuple[pd.DataFrame, pd.Series]:
    ...
    """
    data_path = "C:\\Users\\schne\\OneDrive\\Desktop\\udemy\\MLOPS\\projeto_MLOPS\\mlops_project\\data\\processed\\test_processed.csv"
...
def evaluate_model(
    ...
    runs = mlflow.search_runs(
        experiment_ids=[mlflow.get_experiment_by_name("ml_classification").experiment_id], order_by =["start_time DESC"], max_results=1)
    ...
    with mlflow.start_run(run_id=run_id):
        ...
        evaluation_path = "C:\\Users\\schne\\OneDrive\\Desktop\\udemy\\MLOPS\\projeto_MLOPS\\mlops_project\\metrics\\evaluation.json"
